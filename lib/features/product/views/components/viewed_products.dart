...
class ViewedProducts extends StatefulWidget {
  const ViewedProducts({super.key});

  @override
  State<ViewedProducts> createState() => _ViewedProductsState();
}

class _ViewedProductsState extends State<ViewedProducts> {
  ...
  Widget build(BuildContext context) {
    return 
      ...
      const Align(
        ...
        child: BodyLabel( label: 'Your recently viewed products',)) , 
